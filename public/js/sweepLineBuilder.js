    ...
    _initEvents(segments) {
        segments.forEach(segment => {
            if (this._comparatorEvents(segment.a, segment.b) < 0) {
                this.events.insert(segment.a, new EventSweep(POINT_LEFT, segment.a, segment));
                this.events.insert(segment.b, new EventSweep(POINT_RIGHT, segment.b, segment));
            } else {
                this.events.insert(segment.a, new EventSweep(POINT_RIGHT, segment.a, segment));
                this.events.insert(segment.b, new EventSweep(POINT_LEFT, segment.b, segment));
            }
        });
    }
        ...
        while(this.events.size > 0 ) {
            ...
            while (this._queue.length > 0) {
                ...
                if (!this.events.find(intersection)) {
                    ...
                    let event = new EventSweep(INTERSECTION, intersection, s, s1);
